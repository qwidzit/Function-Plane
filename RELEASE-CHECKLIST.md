...
|---|---|---|---|
| 1 | Author the remaining 40 levels | Pack III (*Weightless*) is authored — see `levels/r-III.json`. Packs IV, V, Linear and Trig still have no level data and repeat one placeholder. `npm test` prints live coverage. | You |
