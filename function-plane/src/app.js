...
function App() {
  const [settings, setSettings] = useState(() => {
    try {
      return {
        ...SETTINGS_DEFAULTS,
        ...JSON.parse(localStorage.getItem('fp-settings') || '{}')
      };
    } catch {
      return {
        ...SETTINGS_DEFAULTS
  ...
  useEffect(() => {
    ...
    window.fpConfirm = ({
      ...
      danger = false
    } = {}) => new Promise(resolve => setConfirmReq({
      title,
      body,
      confirmLabel,
      danger,
  ...
  const updateSetting = (key, value) => setSettings(s => ({
    ...s,
    [key]: value
  }));
  ...
  useEffect(() => {
    ...
    const newlyUnlocked = list.filter(a => a.check(progress) && !prevUnlockedRef.current.has(a.id));
  ...
  const renderScreen = () => {
    ...
    if (route === 'levels') {
      return /*#__PURE__*/React.createElement(LevelSelector, {
        pack: nav.pack,
        progress: progress,
        density: settings.density,
    ...
    if (route === 'level') {
      ...
      return /*#__PURE__*/React.createElement(LevelScreen, {
    ...
    if (route === 'sandbox') {
      return /*#__PURE__*/React.createElement(LevelStudio, {
        mode: "sandbox",
        onBack: () => navigateBack('main'),
        density: settings.density,
        settings: settings
  ...
  }, renderScreen(), toastQueue.length > 0 && /*#__PURE__*/React.createElement(AchievementToast, {
    key: toastQueue[0].id,
  ...
  }, toast.msg)), confirmReq && /*#__PURE__*/React.createElement("div", {
    onClick: () => {
  ...
  }, confirmReq.title && /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, confirmReq.body), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 10
    }
