...
| 18 | Correct the level count and ad wording | **Done, but the number moved.** The site says 70 levels / 210 stars; five Roman plus four themed packs at ten levels each is **90 levels / 270 stars**, and `legal/WEBSITE-AGENT-PROMPT-PRIVACY-UPDATE.md` now says so — the live site still needs re-sending. No ad claims. The footer's reversed support address was fixed at the same time. | You |
