...
function MathKeyboard({
  ...
  const it = c => /*#__PURE__*/React.createElement("span", null, c);
  ...
  const LEFT = [[k(it('x'), () => ins('x'), 'var', 1, 'x'), k(it('y'), () => ins('y'), 'var', 1, 'y'), k(pow('a', '2'), () => cmd('squared'), 'op', 1, 'squared'), k(pow('a', 'b'), () => cmd('sup'), 'op', 1, 'power')], [k('(', () => ins('('), 'op'), k(')', () => ins(')'), 'op'), k('⌊a⌋', () => ins('⌊'), 'fn'), k('⌈a⌉', () => ins('⌈'), 'fn')], [k('|a|', () => ins('|'), 'fn'), k(',', () => ins(','), 'op'), k(FRAC, () => cmd('frac'), 'op', 1, 'fraction'), k('sgn', () => call('sgn'), 'fn')], [k('ABC', () => setPage('abc'), 'ctrl'), k('√', () => cmd('sqrt'), 'fn'), k(it('e'), () => ins('e'), 'const', 1, 'e'), k('π', () => ins('π'), 'const')]];
  const NUM = [[k('7', () => ins('7'), 'num'), k('8', () => ins('8'), 'num'), k('9', () => ins('9'), 'num'), k('÷', () => cmd('frac'), 'num')], [k('4', () => ins('4'), 'num'), k('5', () => ins('5'), 'num'), k('6', () => ins('6'), 'num'), k('×', () => ins('*'), 'num')], [k('1', () => ins('1'), 'num'), k('2', () => ins('2'), 'num'), k('3', () => ins('3'), 'num'), k('−', () => ins('-'), 'num')], [k('0', () => ins('0'), 'num'), k('.', () => ins('.'), 'num'), k('=', () => ins('='), 'num'), k('+', () => ins('+'), 'num')]];
  const FNS = [[k('sin', () => call('sin'), 'fn'), k('cos', () => call('cos'), 'fn'), k('tan', () => call('tan'), 'fn'), k('ln', () => call('ln'), 'fn'), k('log', () => call('log'), 'fn')], [k('sin⁻¹', () => call('arcsin'), 'fn'), k('cos⁻¹', () => call('arccos'), 'fn'), k('tan⁻¹', () => call('arctan'), 'fn'), k(pow('e', 'x'), () => call('exp'), 'fn', 1, 'e to the x'), k('√', () => cmd('sqrt'), 'fn')], [k('⌊a⌋', () => ins('⌊'), 'fn'), k('⌈a⌉', () => ins('⌈'), 'fn'), k('sgn', () => call('sgn'), 'fn'), k('|a|', () => ins('|'), 'fn'), k(pow('a', 'b'), () => cmd('sup'), 'op', 1, 'power')], [k('Σ', () => ins('sum(1,5,n*x)'), 'adv'), k('d/dx', () => call('deriv'), 'adv'), k('∫', () => call('integ'), 'adv'), k('min', () => call('min'), 'fn'), k('max', () => call('max'), 'fn')]];
