...
- Best times came back after a reset, or a fresh time vanished → a time is
  only as good as its `bestTimeAt`. Anything that sets or merges a best time
  has to carry the date with it, and anything that reads progress from the
